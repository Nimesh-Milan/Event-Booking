...
<div class="bg-gradient-to-r from-brand-primary to-brand-secondary px-4 py-2 text-center text-xs font-medium text-white tracking-wide">
    🎉 Welcome to the Spring 2024 Semester! <a href="/events" class="underline underline-offset-2 hover:text-blue-100">Check out the Welcome Week events.</a>
</div>
        ...
        <div class="flex items-center gap-2">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <a href="/register" class="text-sm font-medium bg-brand-dark text-white px-5 py-2.5 rounded-full hover:bg-brand-primary transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2">
                        Get Started
            ...
            <!-- Mobile Menu Toggle -->
            <button class="md:hidden ml-2 p-2 text-gray-600 hover:bg-gray-100 rounded-lg">
